...
## ส่วนที่ 1: การพัฒนา REST API ด้วย Node.js
...
```
ผลลัพธ์จะแสดง 
![ผลการรัน Server]("./images/run_server.jpg")
...
![หน้าต่าง Postman]("./images/postman.jpg")
...
2. การสร้าง Request อื่นๆ:
  ...
  ### บันทึกผลการทดลอง
  [แทรกรูปผลการ Get ข้อมูลทั้งหมด]
  ...
  ### บันทึกผลการทดลอง
  [แทรกรูปผลการ Get ข้อมูลโดยระบุ ID]
...
![ผลลัพธ์การรัน API Server ด้วย Python]("./images/runPythonApp.jpg")
...
2. สร้าง Request สำหรับทดสอบ:
  ...
  [แทรกรูปผลการเพิ่มข้อมูล]
   ...
   - 
    ### บันทึกผลการทดลอง
  [แทรกรูปผลการเรียกดูข้อมูลทั้งหมด]
